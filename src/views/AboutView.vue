      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hola a todos. Me llamo Fernando Sánchez. Soy un desarrollador web de México.
             Tengo 1 año de experiencia en desarrollo web back-end. Me gusta mucho lo que hago en este momento, en mi opinión,
             la creación de programas no es sólo un trabajo, sino también un arte que tiene valor estético
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp;Mi trabajo consiste en diseñar y desarrollar sitios web que sean funcionales,
            intuitivos y visualmente atractivos. Me encanta darle un toque personalizado a cada proyecto para asegurarme
             de que no solo sea útil, sino también memorable. Mi meta es transmitir el mensaje e identidad de tu marca de
              manera clara, creativa y efectiva, asegurándome de que tu sitio web no solo llame la atención,
              sino que también ofrezca una experiencia excepcional a los usuarios.
             Si estás buscando a alguien que pueda transformar tus ideas en realidad digital,
             ¡estoy aquí para ayudarte! No dudes en ponerte en contacto conmigo
             si deseas discutir tu proyecto o explorar posibles colaboraciones.
             ¡Gracias por tu tiempo y espero trabajar contigo pronto!
          </p>
        </div>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-blue-500 bg-blue-500 bg-opacity-10': activeTab === 1 }" @click="activeTab = 1">Tech Stack</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-blue-500 bg-blue-500 bg-opacity-10': activeTab === 2 }" @click="activeTab = 2">Tools</button>
            </li>
          </ul>
        </div>
        <div v-show="activeTab === 1">
          <div class="grid grid-cols-2 gap-4 pb-32 md:grid-cols-3 md:gap-8 xl:grid-cols-4 xl:gap-10 2xl:gap-12">
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-blue-500 px-2 py-2 hover:bg-blue-500 hover:bg-opacity-10 md:gap-3 lg:px-3">
                ...
                <div class="flex items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div
                    class="status-tech opacity-0 absolute mt-5 text-[10px] text-blue-500 transition-all duration-300 md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                </div>
              </div>
            </div>
